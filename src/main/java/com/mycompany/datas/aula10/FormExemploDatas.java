 ...
 */
public class FormExemploDatas extends javax.swing.JFrame {

    /**
     * Creates new form FormExemploDatas
     */
    public FormExemploDatas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Seletor de Datas"));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if(inicio.after(fim)){
            JOptionPane.showMessageDialog(this, "A data de fim deve "
                    + "ser maior que a data de início!!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormExemploDatas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormExemploDatas().setVisible(true);
            }
        });
    }
